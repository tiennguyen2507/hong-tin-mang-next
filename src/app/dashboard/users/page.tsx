    ...
    <Stack gap={4}>
      <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:gap-3">
        <div className="min-w-0">
          <h1 className="font-heading text-xl font-bold tracking-tight text-[var(--shop-text)] sm:text-2xl">Người dùng</h1>
          <p className="mt-1 text-sm leading-relaxed text-[var(--shop-muted)]">Khách và tài khoản quản trị.</p>
        </div>
